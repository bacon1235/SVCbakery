...
<table>
  <form name="fsearch" method="post" action="S-historysearch.php">
...
<tbody>
        <tr>
          ...
          <td><img src="backend/fileupload/img/<?=$row['PD_Pic']; ?>" width="65px" height="50px"></td>
...
<?php } else { ?>
    ...
    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
        <a class="btn btn-danger"href="S-history.php">ย้อนกลับ</a>
    </div>
</div>
