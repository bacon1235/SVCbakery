...
<div class="container">
    ...
    <div class="imgBox col-sm-6 col-md-4" style="width: 23rem;">
            <img src="backend/fileupload/img/<?=$row['PD_Pic']; ?>" width="260px" height="200px" class="img-thumbnail">  <br>
            <h1>         </h1>
            <h5><?php echo $row['PD_Name']; ?></h5>
            <h6>ราคากล่องละ <?php echo $row['PD_Price']; ?> .-</h6>
    ...
    <?php }else{ ?>
            ...
            <a href="detail_PD.php?PD_No=<?php echo $row['PD_No'];?>" class="btn btn-warning">ดูรายละเอียด</a>
