...
<div class="container">
    ...
    <form class="row g-3" name ="AddProduct_Info" enctype="multipart/form-data" method="POST" action="A-Product_Infoinsert.php">

        <div class="col-md-6">
            <label for="inputPD_No" class="form-label">ลำดับ</label>
            <input type="number" placeholder="ลำดับ" class="form-control" id="inputPD_No" name="PD_No" require>
        </div>

        <div class="col-md-6">
            <label for="inputPD_Pic" class="form-label">รูปภาพสินค้า</label>
            <input type="file" placeholder="รูปภาพสินค้า" class="form-control" id="inputPD_Pic" name="PD_Pic" require accept="image/*">
        </div>

        <div class="col-md-6">
            <label for="inputPD_Name" class="form-label">ชื่อสินค้า</label>
            <input type="text" placeholder="ชื่อสินค้า" class="form-control" id="inputPD_Name" name="PD_Name" require>
        </div>
        ...
        <input type="text" placeholder="รายละเอียดสินค้า" class="form-control" id="inputPD_Detail" name="PD_Detail" require>
        </div>

        <div class="col-md-6">
            <label for="inputPD_amount" class="form-label">จำนวน</label>
            <input type="number" placeholder="ชื่อสินค้า" class="form-control" id="inputPD_amount" name="PD_amount" require>
        </div>

        <div class="col-md-6">
            <label for="inputPD_Price" class="col-sm-2 col-form-label">ราคาสินค้า</label>
            <input type="number" placeholder="ราคาสินค้า" class="form-control" id="inputPD_Price" name="PD_Price" require>
        </div>
        
        <div class="col-md-6">
            <label for="inputdiscount" class="col-sm-2 col-form-label">ส่วนลด</label>
            <input type="number" placeholder="ส่วนลด" class="form-control" id="inputdiscount" name="discount" require>
        </div> 
