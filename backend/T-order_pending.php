...
<?php
 ...
 $sql3 = "SELECT * FROM order_cart  WHERE StatusNo='1' ORDER BY Order_NO DESC limit {$start} , {$perpage} ";
 $result3 = mysqli_query($conn, $sql3);
 ?>

<div class="container">
    <h2>คำสั่งซื้อที่รอชำระเงิน</h2>

<table>

<td><a type="button" class="btn btn-warning" href="T-order_w.php">รอดำเนินการ</a></td>
<td>      </td>
<td><a type="button" class="btn btn-info" href="T-order_ss.php">ชำระเงินเรียบร้อย</a></td>
<td>      </td>
<td><a type="button" class="btn btn-success" href="T-order_end.php">รับสินค้าเรียบร้อย</a></td>
  <form name="fsearch" method="post" action="T-manageorderSearch.php">
    <div class="row height d-flex justify-content-end align-items-end">
        <div class="col-md-3">
    <div class="search">
      <td>ㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤ</td>
...
<?php
 $sql2 = "SELECT * FROM order_cart WHERE StatusNo='1' ";
...
<nav aria-label="Page navigation example">
  <ul class="pagination justify-content-center">
    <li class="page-item">
    <a class="page-link text-dark" href="T-order_pending.php?page=1" aria-label="Previous">
        <span aria-hidden="true">&laquo;</span>
      </a>
    </li>
    <?php for($i=1;$i<=$total_page;$i++){ ?>

    <li class="page-link text-dark"><a class="text-dark" href="T-order_pending.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
    <?php } ?>
    <li class="page-link text-dark">
    <a class="text-dark" href="T-order_pending.php?page=<?php echo $total_page;?>" aria-label="Next">
