...
<?php
 ...
 $sql3 = "SELECT * FROM order_cart ORDER BY Order_NO DESC limit {$start} , {$perpage} ";
...
<nav aria-label="Page navigation example">
  <ul class="pagination justify-content-center">
    <li class="page-item">
    <a class="page-link text-dark" href="T-manageorder.php?page=1" aria-label="Previous">
        <span aria-hidden="true">&laquo;</span>
      </a>
    </li>
    <?php for($i=1;$i<=$total_page;$i++){ ?>

    <li class="page-link text-dark"><a class="text-dark" href="T-manageorder.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
    <?php } ?>
    <li class="page-link text-dark">
    <a class="text-dark" href="T-manageorder.php?page=<?php echo $total_page;?>" aria-label="Next">
