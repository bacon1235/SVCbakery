...
//ตัวแปรSession
        ...
        $rs_discount=$row_pro['PD_Price']*(100-$discount)/100;
        $sum = $Total*$rs_discount;
        $sumPrice =$sumPrice + $sum;
        $_SESSION["sum_Price"] = $sumPrice;
        $_SESSION["rs_discount"] = $rs_discount;
        //sum = จำนวนสินค้า*ราคาของชิ้นนั้น sumPrice=ยอดรวมทั้งหมด
?>

            <tbody>
                <td><?=$m?></td>
                <td><img src="fileupload/img/<?=$row_pro['PD_Pic']; ?>" width="65" height="50"></td>
...
<div style="text-align: right;">
    <a href="T-index.php"><button type="button" class="btn btn-warning">เลือกสินค้าเพิ่ม</button></a>
