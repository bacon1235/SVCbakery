      ...
      <div class="card-body">
        <div class="row">
          <div class="col-md-6">
            ...
            <form class="row g-1" name ="update_order_detail" method="POST" action="T-change_status.php">
...
<br><h1></h1>
        ...
        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
            <a class="btn btn-danger" type="cancel" value="ยกเลิก" href="T-manageorder.php">ยกเลิก</a>
